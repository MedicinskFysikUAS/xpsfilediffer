...
!define ApplicationRootName "ArkiveraXps"
...
!define archiveXpsOutDir "bin\archiveXps"
!define archiveXpsDir "..\${archiveXpsOutDir}"
!define archiveXpsOutDirPath "${ApplicationDir}\${archiveXpsOutDir}"
...
CreateDirectory "${ApplicationDir}\${archiveXpsOutDir}" 
...
File "${installerDir}\archiveIcon.ico"
File "${installerDir}\${vbsScriptName}"


# archiveXps
SetOutPath "${archiveXpsOutDirPath}"
File /r "${archiveXpsDir}\*.*"
